...
{
    public class IntermediateCatchEventFactory : BaseFactory
    {
        ...
        public override IOwlIndividual Create(Shape shape)
        {
            IOwlIndividual individual = new OwlIndividual(
                ...
                (OwlNode)base._graph.Nodes[ToolKit.GetFullName(Constant.BPMN_TARGET_NAMESPACE, "intermediateCatchEvent")]);
